...
const STORY_DATA = {
    ...
    6: {
        title: 'Путь домой',
        scenes: [
            { character: 'narrator', text: 'Это последнее испытание первой части! Впереди — дом {tiger}.' },
    ...
    7: {
        ...
        scenes: [
            { character: 'narrator', text: '{tiger} отдохнул дома и решил исследовать новые территории леса!' },
            { character: 'tiger', text: 'Я стал сильнее! Впереди две стены деревьев — надо найти проходы!' },
            { character: 'narrator', text: '{name}, используй разные направления движения! Ищи проход в каждой стене.' }
        ]
    },
    8: {
        title: 'Молния',
        scenes: [
            { character: 'narrator', text: 'Впереди — зигзагообразный путь через густые заросли!' },
            { character: 'tiger', text: 'Ого, тут стены в три ряда! Придётся двигаться как молния — зигзагом!' },
            { character: 'narrator', text: '{name}, научи {tiger} проходить зигзагом. Чередуй вправо() и вниз()!' }
        ]
    },
    9: {
        title: 'Каменное кольцо',
        scenes: [
            { character: 'narrator', text: '{tiger} обнаружил загадочное каменное кольцо в центре поляны.' },
            { character: 'tiger', text: 'Что это? Какой-то древний круг из камней... Мясо вокруг, а ключ рядом!' },
            { character: 'narrator', text: '{name}, обойди кольцо вокруг, собери мясо и открой дверь к выходу!' }
        ]
    },
    10: {
        title: 'Три коридора',
        scenes: [
            { character: 'narrator', text: 'Три огромные стены разделили лес на узкие коридоры!' },
            { character: 'tiger', text: 'Это как лабиринт! В каждой стене только одна щель для прохода...' },
            { character: 'narrator', text: '{name}, планируй маршрут через все три стены. Не забудь ключ в углу!' }
        ]
    },
    11: {
        title: 'Мастер ключей',
        scenes: [
            { character: 'narrator', text: '{tiger} наткнулся на три запертых двери подряд!' },
            { character: 'tiger', text: 'Три двери?! Мне нужно три ключа! Один для каждой двери!' },
            { character: 'narrator', text: '{name}, подбирай ключи по очереди. Взять() → подойти к двери → открыть()!' }
        ]
    },
    12: {
        title: 'Запутанный лабиринт',
        scenes: [
            { character: 'narrator', text: 'Впереди — настоящий лабиринт со множеством тупиков!' },
            { character: 'tiger', text: 'Здесь столько поворотов! Нужно внимательно планировать каждый шаг!' },
            { character: 'narrator', text: '{name}, используй числа: вправо(3) = три шага. Это сэкономит команды!' }
        ]
    },
    13: {
        title: 'Штурм крепости',
        scenes: [
            { character: 'narrator', text: 'Перед {tiger} — крепость из деревьев! Мясо спрятано внутри.' },
            { character: 'tiger', text: 'Крепость! Ключи должны быть где-то снаружи... Надо обойти всё вокруг!' },
            { character: 'narrator', text: '{name}, сначала обследуй периметр, найди ключи в углах и штурмуй крепость!' }
        ]
    },
    14: {
        title: 'Непроглядная чаща',
        scenes: [
            { character: 'narrator', text: 'Лес стал настолько густым, что деревья растут в шахматном порядке!' },
            { character: 'tiger', text: 'Тут еле-еле можно протиснуться! Каждый шаг — это вызов!' },
            { character: 'narrator', text: '{name}, тропы извилисты и узки. Один неверный шаг — и путь заблокирован!' }
        ]
    },
    15: {
        title: 'Великий побег',
        scenes: [
            { character: 'narrator', text: 'Финальное испытание! Самый длинный и сложный путь через весь лес.' },
            { character: 'tiger', text: '{name}, это наш последний поход! Семь кусков мяса, два ключа, три двери!' },
            { character: 'narrator', text: 'Собери ВСЁ мясо, найди ВСЕ ключи и открой ВСЕ двери. Приведи {tiger} домой навсегда! 🏠🎊' }
        ]
    },
    ending: {
        title: 'Домой!',
